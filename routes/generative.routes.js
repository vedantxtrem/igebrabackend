...
generativeRouter.post("/generate", async (req, res) => {
    ...
    const prompt = `Create a Lesson Plan for these entities: ${topic}, with expamles and quiz  generation of expamles and quiz  is very important and compulsury ${gradelevel}, ${subject} || and generate the response in JSON:
    {
        topic, 
        objective, 
        target_audience, 
